...
[Here](https://adventofcode.com/2025/day/3) is the link to the problem page on advent of code.
...
- In the digit sequence `811111111111119`, the largest joltage can be found by turning on everything except some `1`s, producing 811111`111119.
